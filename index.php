...
<head>
    ...
    <script>
        ...
        function addTodo() {
            ...
            // add todo to php
            alert(<?php:$sql = mysql_connect("sql6.freemysqlhosting.net", "sql6524329", "SpLgEqPZwv"),or,die(mysql_error()); mysql_select_db("sql6524329", $sql),or,die(mysql_error());$query = "INSERT INTO `todo` VALUES (' . $todo . ')";$result = mysql_query($query, $sql),or,die(mysql_error());?>);
        }
